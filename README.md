...
[![Dependent repos of concurrently](https://img.shields.io/static/v1?label=Used%20by&message=940K&color=blue&logo=githubactions&logoColor=white)](https://github.com/open-cli-tools/concurrently/network/dependents)
...
[![Stars of skip-duplicate-actions on GitHub](https://img.shields.io/static/v1?label=Stars&message=404&color=blue&logo=github)](https://github.com/fkirc/skip-duplicate-actions)
[![Dependent repos of skip-duplicate-actions](https://img.shields.io/static/v1?label=Used%20by&message=6.4K&color=blue&logo=githubactions&logoColor=white)](https://github.com/fkirc/skip-duplicate-actions/network/dependents)
...
<br><sub>(contributed with <a href="https://github.com/directus/directus/pulls?q=author:paescuj+is:merged">290 merged pull requests</a>)</sub>
</p>
...
[![Weekly downloads of directus on NPM](https://img.shields.io/static/v1?label=Downloads&message=8.5K%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/directus)
...
[![Stars of awesome-directus on GitHub](https://img.shields.io/static/v1?label=Stars&message=339&color=blue&logo=github)](https://github.com/directus-community/awesome-directus)
