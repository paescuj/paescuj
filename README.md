...
[![Weekly downloads of iconoir on NPM](https://img.shields.io/static/v1?label=Downloads&message=12K%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/iconoir)
...
[![Stars of skip-duplicate-actions on GitHub](https://img.shields.io/static/v1?label=Stars&message=529&color=blue&logo=github)](https://github.com/fkirc/skip-duplicate-actions)
...
[![Stars of eslint-plugin-vitest on GitHub](https://img.shields.io/static/v1?label=Stars&message=474&color=blue&logo=github)](https://github.com/vitest-dev/eslint-plugin-vitest)
