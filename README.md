...
[![Stars of concurrently on GitHub](https://img.shields.io/static/v1?label=Stars&message=7.7K&color=blue&logo=github)](https://github.com/open-cli-tools/concurrently)
[![Weekly downloads of concurrently on NPM](https://img.shields.io/static/v1?label=Downloads&message=15M%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/concurrently)
...
[![Stars of iconoir on GitHub](https://img.shields.io/static/v1?label=Stars&message=4.4K&color=blue&logo=github)](https://github.com/iconoir-icons/iconoir)
[![Weekly downloads of iconoir on NPM](https://img.shields.io/static/v1?label=Downloads&message=11K%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/iconoir)
[![Top language of iconoir](https://img.shields.io/static/v1?label=TypeScript&message=55%25&color=3178c6)](https://github.com/iconoir-icons/iconoir)
...
[![Stars of skip-duplicate-actions on GitHub](https://img.shields.io/static/v1?label=Stars&message=530&color=blue&logo=github)](https://github.com/fkirc/skip-duplicate-actions)
[![Dependent repos of skip-duplicate-actions](https://img.shields.io/static/v1?label=Used%20by&message=9.5K&color=blue&logo=githubactions&logoColor=white)](https://github.com/fkirc/skip-duplicate-actions/network/dependents)
...
[![Stars of directus on GitHub](https://img.shields.io/static/v1?label=Stars&message=35K&color=blue&logo=github)](https://github.com/directus/directus)
...
[![Stars of eslint-plugin-vitest on GitHub](https://img.shields.io/static/v1?label=Stars&message=478&color=blue&logo=github)](https://github.com/vitest-dev/eslint-plugin-vitest)
