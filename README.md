...
[![Dependent repos of concurrently](https://img.shields.io/static/v1?label=Used%20by&message=931K&color=blue&logo=githubactions&logoColor=white)](https://github.com/open-cli-tools/concurrently/network/dependents)
...
[![Stars of skip-duplicate-actions on GitHub](https://img.shields.io/static/v1?label=Stars&message=403&color=blue&logo=github)](https://github.com/fkirc/skip-duplicate-actions)
...
[![Top language of iconoir](https://img.shields.io/static/v1?label=TypeScript&message=53%25&color=3178c6)](https://github.com/iconoir-icons/iconoir)
...
<br><sub>(contributed with <a href="https://github.com/directus/directus/pulls?q=author:paescuj+is:merged">279 merged pull requests</a>)</sub>
</p>
...
[![Weekly downloads of directus on NPM](https://img.shields.io/static/v1?label=Downloads&message=10K%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/directus)
...
[![Stars of awesome-directus on GitHub](https://img.shields.io/static/v1?label=Stars&message=334&color=blue&logo=github)](https://github.com/directus-community/awesome-directus)
