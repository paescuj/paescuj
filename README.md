...
[![Weekly downloads of iconoir on NPM](https://img.shields.io/static/v1?label=Downloads&message=6.7K%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/iconoir)
...
[![Dependent repos of skip-duplicate-actions](https://img.shields.io/static/v1?label=Used%20by&message=8.8K&color=blue&logo=githubactions&logoColor=white)](https://github.com/fkirc/skip-duplicate-actions/network/dependents)
...
[![Stars of awesome-directus on GitHub](https://img.shields.io/static/v1?label=Stars&message=600&color=blue&logo=github)](https://github.com/directus-labs/awesome-directus)
