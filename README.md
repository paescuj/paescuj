...
[![Weekly downloads of concurrently on NPM](https://img.shields.io/static/v1?label=Downloads&message=5.6M%2Fweek&color=brightgreen&logo=npm)](https://www.npmjs.com/package/concurrently)
...
[![Stars of skip-duplicate-actions on GitHub](https://img.shields.io/static/v1?label=Stars&message=475&color=blue&logo=github)](https://github.com/fkirc/skip-duplicate-actions)
...
[![Stars of awesome-directus on GitHub](https://img.shields.io/static/v1?label=Stars&message=557&color=blue&logo=github)](https://github.com/directus-labs/awesome-directus)
